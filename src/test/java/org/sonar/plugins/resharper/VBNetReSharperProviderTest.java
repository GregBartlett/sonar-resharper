...
public class VBNetReSharperProviderTest {
  ...
  @Test
  public void test() {
    assertThat(nonProperties(new VBNetReSharperProvider().extensions())).containsOnly(
      VBNetReSharperRuleRepository.class,
      VBNetReSharperSensor.class);
    assertThat(propertyKeys(new VBNetReSharperProvider().extensions())).containsOnly(
      "sonar.vbnet.resharper.project.name",
      "sonar.vbnet.resharper.solution.file",
      "sonar.vbnet.resharper.inspectcode.path");
  }
